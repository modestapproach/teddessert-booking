...
export const calendarsRouter = router({
  ...
  startGoogleConnect: authedProcedure.mutation(async ({ ctx }) => {
    const { startGoogleConnectHandler } = await import("./startGoogleConnect.handler");

    return startGoogleConnectHandler({ ctx });
  }),
});
