...
export type InnerContext = CreateInnerContextOptions & {
  ...
  /**
   * dibslist data-layer rewire: server-side Convex client (meadowlark).
   * Resolvers being migrated off Prisma read/write through this.
   * @see packages/lib/server/convex.ts
   */
