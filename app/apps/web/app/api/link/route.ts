...
async function handler(request: NextRequest) {
  ...
  // no-Postgres fork: the cal confirm-via-magic-link flow is prisma-heavy (booking/user reads +
  // confirmHandler) and unused — fork bookings auto-accept via Convex. Skip it and land the user on
  // their (working, Convex-backed) booking page.
