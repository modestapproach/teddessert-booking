...
async function handleBookingAction(
  ...
  // no-Postgres fork: confirm-via-token reads prisma.booking/user + runs cal's confirmHandler — all
  // prisma, and unused (fork bookings auto-accept via Convex). Land the user on their booking page.
