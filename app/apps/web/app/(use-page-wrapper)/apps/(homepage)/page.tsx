...
const ServerPage = async () => {
  ...
  try {
    ...
    // no-Postgres fork: the app-store registry reads `prisma.app`/`prisma.credential` → THROW.
    // Render an empty store instead of crashing the route; connections live in
    // /settings/my-account/calendars + /conferencing (Convex-backed) on the fork.
    appStore = [];
    userAdminTeamsIds = [];
  }
