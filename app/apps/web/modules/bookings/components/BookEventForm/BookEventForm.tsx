...
export const BookEventForm = ({
  ...
  // BOOKING-LOTTERY — "???" interaction modes drive the submit copy: a lottery
  // submit is a drawing ENTRY; a first_come submit is an instant CLAIM.
  // `interactionMode` is an extra (non-cal) field from the Convex public-event
  // adapter, hence the cast.
  ...
  const isLotteryEvent = interactionMode === "lottery";
  const isFirstComeEvent = interactionMode === "first_come";
  const w2ButtonLabel =
