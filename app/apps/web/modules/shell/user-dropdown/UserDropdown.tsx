    ...
    <Menu open={menuOpen} onOpenChange={setMenuOpen}>
      ...
      <>
        <MenuPopup align="start">
          ...
          <MenuItem render={<a href="https://teddessert.com" />}>
            <ArrowLeftIcon />
            Back to teddessert.com
          </MenuItem>
          ...
          <MenuItem
            variant="destructive"
            onClick={() => {
              // The booking session is the owner cookie, NOT a cal NextAuth cookie —
              // cal's signOut() would leave the owner logged in. Hit our route to clear it.
              if (process.env.NEXT_PUBLIC_CONVEX_URL) {
                window.location.href = "/api/auth/dibslist-logout";
                return;
              }
