...
const UserProfile = ({ user }: UserProfileProps) => {
  ...
  const mutation = trpc.viewer.me.updateProfile.useMutation({
    onSuccess: async () => {
      ...
      // Go straight to the dashboard rather than "/" — the root onboarding gate
      // reads the 60s-cached session, which can still show completedOnboarding
      // =false right after Finish and bounce the owner back into onboarding.
      // /event-types doesn't re-gate, so this avoids that transient loop.
